...
const Footer = () => {
  return (
    <>
      <div className="bg-0001">
        <div className="container ">
          <div className="flex justify-center sm:justify-start">
            <div className="border border-t-0002 border-t-[4px] w-[101px]"></div>
          </div>
          <div className="md:pt-[75px] sm:pt-[60px] pt-[52px]  pb-12">
            <div className="flex justify-between items-center sm:items-start sm:gap-8 gap-12 md:flex-row flex-col">
              <Link to="/">
                <svg
            ...
            <div className="flex justify-between items-end pt-9 pb-14">
              <p className="md:w-[540px] font-manrope cursor-default text-white text-[15px] leading-[25px] opacity-[0.5] text-center sm:text-start">
            ...
            <div className="flex flex-col sm:flex-row items-center md:items-start justify-between  gap-12">
              <p className="text-white cursor-default text-[15px] font-manrope font-bold leading-[25px] opacity-[0.5]">
